     ...
     <div class="col-md-6">
      ...
      <div class="modal-footer">
        ...
        <div class="card">
            ...
            <button style="margin-left:440px;" type="button" class="btn btn-primary btn-sm" onclick="location.href = 'reports.php';" > Bill Report</button>&nbsp
...
<br>
         ...
         <div id="printableArea">          
            ...
            <?php
                ...
                $query ="SELECT *, payment.encoded_by FROM payment INNER JOIN customer on customer.id = payment.customer_id 
                WHERE date_paid BETWEEN '$from_date' AND '$to_date'";
